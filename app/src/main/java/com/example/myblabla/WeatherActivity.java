...
import com.example.myblabla.gson.Forecast;
import com.example.myblabla.gson.Weather;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=4bae01aed46944daa2ebf4021b1bac4b";
